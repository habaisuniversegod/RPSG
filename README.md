...
Зайдите в терминал и готовьтесь копипастить следующие команды: скопируйте репозиторий
    ...
    $ git clone https://github.com/habaisuniversegod/RPSG.git
...
Натравливаем `make` на это добро:
...
Случайное число от -1 до 1| rand | 1 | srand(a); (rand() / (double)RAND_MAX - 0.5) * 2.0 
